...
public interface ABCMusicListener extends ParseTreeListener {
	...
	void enterFieldtitletext(ABCMusicParser.FieldtitletextContext ctx);
	void exitFieldtitletext(ABCMusicParser.FieldtitletextContext ctx);
	...
	void enterComposername(ABCMusicParser.ComposernameContext ctx);
	void exitComposername(ABCMusicParser.ComposernameContext ctx);
}