...
/**
 * A group of functions that builds AST's for some of the
 * warmup pieces, converts them with a SoundConverter,
 * then plays them with a SoundPlayer.
 */
public class TestConverterAndPlayer{
    
    public static void main(String[] args){
        // Comment out one of the lines to play a song
        // playRowYourBoat();
        // playMarioRepeat();
        playMario();
    }
    ...
    static void playRowYourBoat(){
        ...
        SongPlayer songPlayer = new SongPlayer(ps, new ConsoleLyricListener());
